...
namespace Car_Rental_App.ViewModels
{
    class SideMenuViewModel
    {
        ...
        ResourceDictionary dict = Application.LoadComponent(new Uri("/Car Rental App;component/Assets/IconDictionary.xaml", UriKind.RelativeOrAbsolute)) as ResourceDictionary;
